...
Task.prototype.StartDate = function(){
	return new Date(this.start);
}

Task.prototype.EndDate = function(){
	if(this.end != null)
...
function LoadTaskStyles(){
	...
	//Defauts
	TaskStyles.push(new TaskStyle("ticket", "#DD6100", "#FFF") );
...
TimeCalculator.prototype.TimeSpentOnTask_InHours =  function(task_id){
...
TimeCalculator.prototype.Diff_InSeconds = function(startDate, endDate){
	var difference = this.GetDifference(startDate, endDate);
	return Math.floor(difference/1000);
}

TimeCalculator.prototype.GetDifference = function(startDate, endDate){
